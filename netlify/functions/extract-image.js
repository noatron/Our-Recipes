...
דוגמה למבנה:
{"name": "עוגת שוקולד", "ingredients": ["2 ביצים", "1 כוס סוכר", "1 כוס קמח", "3 כפות קקאו"], "instructions": ["לחמם תנור ל-180 מעלות.", "לערבב ביצים וסוכר.", "להוסיף קמח וקקאו ולערבב.", "לאפות 25 דקות."], "suggestedTags": ["שוקולד", "קינוחים"]}

תגיות מותרות (בחרי רק מהרשימה): בשר, דגים, פסטות, טרטים ופשטידות, צמחוני, סלטים, תוספות, לחם ומאפים, רוטבים וממרחים, מרקים, עוגות, עוגיות, קינוחים, שוקולד, ארוחות בוקר, חטיפים, שתייה.`;
